...
describe('Prompt Registration', () => {
  ...
  it('should register review_merge_request prompt', () => {
    ...
    const handler = mockServer.registerPrompt.mock.calls.find((call: any) => call[0] === 'review_merge_request')[2];
  ...
  it('should register review_pull_request prompt', () => {
    ...
    const handler = mockServer.registerPrompt.mock.calls.find((call: any) => call[0] === 'review_pull_request')[2];
